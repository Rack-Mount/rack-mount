...
export interface LocationServiceInterface {
   ...
   * @param requestParameters
   */
  locationLocationcustomfiledCreate(
   ...
   * @param requestParameters
   */
  locationLocationcustomfiledDestroy(
   ...
   * @param requestParameters
   */
  locationLocationcustomfiledList(
   ...
   * @param requestParameters
   */
  locationLocationcustomfiledPartialUpdate(
   ...
   * @param requestParameters
   */
  locationLocationcustomfiledRetrieve(
   ...
   * @param requestParameters
   */
  locationLocationcustomfiledUpdate(

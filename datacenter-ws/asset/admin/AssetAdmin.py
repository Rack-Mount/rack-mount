...
class AssetAdmin(VersionAdmin):
    ...
    list_display = ('hostname', 'rack', 'model__type', 'model__name', 'model__vendor',
                    'serial_number', 'sap_id', 'model__rack_units', 'power_cosumption_watt', 'state', 'purchase_date')
    ...
    readonly_fields = ['front_image_preview',
                       'rear_image_preview', 'location', 'created_at', 'updated_at']

    inlines = [AssetCustomFieldInline]
    autocomplete_fields = ['model', 'location', 'rack']
